        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-emerald-400 text-sm">Operator Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div>
            <h1 className="text-4xl font-bold text-white leading-tight mb-4">
              Intelligent EV<br />
              <span className="text-emerald-400">Grid Management</span>
            </h1>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-500 text-sm">Sign in to your operator account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                  required
                />
              </div>
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-gray-200 rounded-xl px-4 py-3 pr-12 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                    required
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-emerald-500 hover:bg-emerald-600 disabled:opacity-60 text-white font-bold py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/40"
              >
                {loading ? (
                  <>
            ...
            <div className="mt-6 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
              ...
              <p className="text-xs text-emerald-600">Password: <span className="font-bold">any value</span></p>
            </div>
          </div>
